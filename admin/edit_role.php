...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($role_name) || $status === '') {
        $_SESSION['toast'] = [
            'type' => 'error',
            'message' => '❌ Please fill all required fields.'
        ];
    } else {
        $update_sql = "UPDATE role SET role_name = '$role_name', status = '$status', updated = NOW() WHERE id = $id";
                    ...
                    <div class="card-body">
                        <form method="POST">
                            <div class="row">
                                <div class="col-sm-6">
                                    <label>Role</label>
                                    <input type="text" name="role_name" class="form-control" value="<?= htmlspecialchars($data["role_name"] ?? ''); ?>">
                                </div>
                                <div class="col-sm-6 ">
                            ...
                            <div class="row mt-4">
                                <div class="col-sm-12">
                                    ...
                                    <a href="role.php" class="btn btn-secondary ml-2">Back</a>
                                </div>
                            </div>
                        </form>
                    </div>
